#ifndef LIBCLOD_SERIALISE_INTEGER_LE_H
#define LIBCLOD_SERIALISE_INTEGER_LE_H
...
static inline void leu8_enc (uint8_t ptr[1], const uint8_t  val) { ptr[0] = (uint8_t)val; }
/// Encode a 16-bit unsigned integer into little-endian format.
static inline void leu16_enc(uint8_t ptr[2], const uint16_t val) { ptr[1] = (uint8_t)(val >> 8 ); ptr[0] = (uint8_t)val; }
/// Encode a 24-bit unsigned integer into little-endian format.
static inline void leu24_enc(uint8_t ptr[3], const uint32_t val) { ptr[2] = (uint8_t)(val >> 16); ptr[1] = (uint8_t)(val >> 8 ); ptr[0] = (uint8_t)val; }
/// Encode a 32-bit unsigned integer into little-endian format.
static inline void leu32_enc(uint8_t ptr[4], const uint32_t val) { ptr[3] = (uint8_t)(val >> 24); ptr[2] = (uint8_t)(val >> 16); ptr[1] = (uint8_t)(val >> 8 ); ptr[0] = (uint8_t)val; }
/// Encode a 40-bit unsigned integer into little-endian format.
static inline void leu40_enc(uint8_t ptr[5], const uint64_t val) { ptr[4] = (uint8_t)(val >> 32); ptr[3] = (uint8_t)(val >> 24); ptr[2] = (uint8_t)(val >> 16); ptr[1] = (uint8_t)(val >> 8 ); ptr[0] = (uint8_t)val; }
/// Encode a 48-bit unsigned integer into little-endian format.
static inline void leu48_enc(uint8_t ptr[6], const uint64_t val) { ptr[5] = (uint8_t)(val >> 40); ptr[4] = (uint8_t)(val >> 32); ptr[3] = (uint8_t)(val >> 24); ptr[2] = (uint8_t)(val >> 16); ptr[1] = (uint8_t)(val >> 8 ); ptr[0] = (uint8_t)val; }
/// Encode a 56-bit unsigned integer into little-endian format.
static inline void leu56_enc(uint8_t ptr[7], const uint64_t val) { ptr[6] = (uint8_t)(val >> 48); ptr[5] = (uint8_t)(val >> 40); ptr[4] = (uint8_t)(val >> 32); ptr[3] = (uint8_t)(val >> 24); ptr[2] = (uint8_t)(val >> 16); ptr[1] = (uint8_t)(val >> 8 ); ptr[0] = (uint8_t)val; }
/// Encode a 64-bit unsigned integer into little-endian format.
static inline void leu64_enc(uint8_t ptr[8], const uint64_t val) { ptr[7] = (uint8_t)(val >> 56); ptr[6] = (uint8_t)(val >> 48); ptr[5] = (uint8_t)(val >> 40); ptr[4] = (uint8_t)(val >> 32); ptr[3] = (uint8_t)(val >> 24); ptr[2] = (uint8_t)(val >> 16); ptr[1] = (uint8_t)(val >> 8); ptr[0] = (uint8_t)val; }
...
static inline bool leuv_enc(uint8_t *ptr, const void *end, const uint64_t val) {
...
/// @return True if the buffer was large enough.
static inline bool leiv_enc(uint8_t *ptr, const void *end, const int64_t val) {
...
static inline bool leiv_dec(const uint8_t *ptr, const void *end, int64_t *val) {
	...
	if (i < 9 && ptr[i] & 0b01000000) ret |= (int64_t)(~UINT64_C(0) << ((i + 1) * 7));
	*val = ret;
	return true;
}
